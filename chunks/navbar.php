		...
		<nav>
		    <div class="nav-wrapper">
		      ...
		      <ul class="right hide-on-med-and-down">
				...
				<li><a href="/RestroGirls/admin/index.php" class="hvr-grow">Admin</a></li>
				<li><a href="#" class="hvr-grow modal-trigger" data-target="feedback-modal">Feedback</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
			...
			<li><a href="/RestroGirls/admin/index.php" class="hvr-grow">Admin</a></li>
		<li><a href="#" class="modal-trigger" data-target="feedback-modal">Feedback</a></li>
